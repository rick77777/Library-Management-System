<%-- 
    Document   : editBook
    Created on : 26 Apr, 2020, 10:46:15 AM
    Author     : CHIRADIP
--%>
...
<!-- Page Heading -->
        <table class="content" border='1' cellpadding='2' cellspacing='0' width='800'>
            <tr bgcolor='#cab3ff' align='center'>
                <td><h2>Library Management System: Edit Book Details</h2>
                </td></tr> 
        </table><br>
<p>
<center>
    Enter all the details of the book you want to modify<br>
(The Book ID must correspond to the book you want to modify)
</center>
</p>
...
<table class="content" cellpadding='5' cellspacing='10' width='400'>
            ...
            <tr align='center'>
                <td>Available Copies : <input type='text' name='availcopy' value="<%=book.getAvailCopies()%>"><br/>
                </td>
            </tr>
            <tr align='center'>
                <td><input class='buttony' type="submit" value="Edit Book">
                </td>
            </tr>
        </table>  
</form>
